...
HD_PWD='D:/FPGA/Lab1/PLDLSTM/PLDLSTM.runs/design_1_LSTM_Top_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_LSTM_Top_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_LSTM_Top_0_1.tcl
