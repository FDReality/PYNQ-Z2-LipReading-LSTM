...
// ==============================================================
#ifndef __LSTM_Top_fptrunc_dEe__HH__
#define __LSTM_Top_fptrunc_dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_fptrunc_dEe) {
    ...
    SC_CTOR(LSTM_Top_fptrunc_dEe):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
